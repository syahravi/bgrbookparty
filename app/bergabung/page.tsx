        ...
        <main className="pt-20">
            <section className="py-24 bg-gradient-to-b from-[#F5F0E8] to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <a href="https://wa.me/6288905683079?text=Halo%20Bogor%20Book%20Party!%20Saya%20ingin%20bergabung%20dengan%20komunitas." target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-[#1B5E3F] text-white font-bold rounded-full hover:scale-105 transition-all inline-flex items-center gap-2 shadow-xl">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-gradient-to-br from-[#1B5E3F] to-[#2E7D5A] rounded-3xl p-8 md:p-12 text-center text-white">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <a href="https://wa.me/6288905683079" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-white text-[#1B5E3F] font-bold rounded-full hover:scale-105 transition-all flex items-center gap-2">
