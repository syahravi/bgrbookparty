    ...
    const contacts = [
        {
            icon: "📱",
            title: "Minbuk BBP",
            value: "+62 889-0568-3079",
            link: "https://wa.me/6288905683079",
            type: "WhatsApp",
        },
        {
            icon: "📧",
        ...
        <main className="pt-20">
            ...
            <section className="py-16 bg-gradient-to-r from-[#1B5E3F] to-[#2E7D5A]">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <a href="https://wa.me/6288905683079?text=Halo%20Bogor%20Book%20Party!%20Saya%20ingin%20bertanya%20tentang%20kegiatan%20BBP." target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-[#25D366] text-white font-bold rounded-full hover:scale-105 transition-all inline-flex items-center gap-2 shadow-lg">
