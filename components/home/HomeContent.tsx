...
import type { BaserowStat, BaserowEvent, BaserowTestimonial } from '@/types/baserow';

interface HomeContentProps {
  stats: BaserowStat[];
  upcomingEvents: BaserowEvent[];
...
export default function HomeContent({ stats, upcomingEvents, testimonials }: HomeContentProps) {
  return (
    <>
      {/* Hero Section */}
